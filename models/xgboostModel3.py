# xgboost model for featureEnginnering4.py dataset
# %%
import numpy as np
import pandas as pd
...
# %%
dataset = pd.read_csv('../dataset/scaled_train_4.csv')
# %%
...
# %%
filename = '../compiled_models/xgboost_3.pkl'
...
sample.to_csv('../submissions/sample_submission5.csv', index=False)
# %%
