# min max scaling and normalization for dataset from featureEnginnering.py without sp and ordinal encoder
# %%
import numpy as np
import pandas as pd
...
# %%
dataset2.to_csv('../dataset/scaled_train_3.csv', index=False)
# %%
